...
class JwtTokenProvider(
    ...
    fun createAccessToken(userId: String): String = createToken(userId, accessTokenValidity)

    fun createRefreshToken(userId: String): String = createToken(userId, refreshTokenValidity)
